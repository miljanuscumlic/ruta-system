 ...
 */
public class RutaMyPartyExistMapper extends XmlMapper<MyParty>
{
	...
	public RutaMyPartyExistMapper(RutaClient client, ExistConnector connector) throws DetailException
	{
		super(connector);
