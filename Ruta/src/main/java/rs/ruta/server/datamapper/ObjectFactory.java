 ...
 * {@code ObjectFactory} has two methods for every class which object it is mapping. One method is for instantiating
...
public class ObjectFactory
{
	...
	public final static QName _User_QNAME = new QName("urn:rs:ruts:services", "User");

	/**Creates an instance of {@link ExistTransaction}.
     * @return created {@code ExistTransaction} object and never <code>null</code>
     */
    @Nonnull
    ...
    * @return created JAXBElement and never <code>null</code>
    */
    ...
    * @return created {@code PartyID} object and never <code>null</code>
    */
   @Nonnull
   ...
   * @return created JAXBElement and never <code>null</code>
   */
@XmlElementDecl(namespace = "urn:rs:ruts:services", name = "User")
  @Nonnull
